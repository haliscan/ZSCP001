sap.ui.define(
	...
	function (
		...
		return Controller.extend("com.tupras.zsrmscp.controller.Cart", {
			...
			onButtonValidateTypePress: function (oEvent) {
				debugger;
				var oCardProduct = oEvent.getSource().getBindingContext("cartProducts"),
					oModel = this.getOwnerComponent().getModel(),
					aFilter = [];
				aFilter.push(new Filter("Matnr", FilterOperator.EQ, oCardProduct.getProperty("Prodi")));
				aFilter.push(new Filter("Werks", FilterOperator.EQ, oCardProduct.getProperty("Werks")));

				oModel.read("/ValuationTypeSet", {
					filters: aFilter,
					success: function (oData) {
						debugger;
						this._openValuationDialog(oData.results);
					}.bind(this),
			...
			_openValuationDialog: function (e) {
				this.oValuationDialog = sap.ui.xmlfragment(this.getView().getId(), "com.tupras.zsrmscp.view.Dialogs.ValuationDialog", this);
				var o = new JSONModel;
				o.setData(e);
				this.oValuationDialog.setModel(o, "valuationModel");
				this.oValuationDialog.open();
			},
			handlePressValuationKapat: function (e) {
				this.oValuationDialog.close();
				this.oValuationDialog.destroy()
			},
