sap.ui.define(
	[
		...
		"com/tupras/zsrmscp/utils/CustomizeScreen",
		"sap/m/MessageBox",
		"sap/ui/model/Filter",
		...
		return e.extend("com.tupras.zsrmscp.controller.Detail", {
			...
			_onRouteMatched: function (e) {
				...
				if (i === "Olustur") {
					this.getView()
						...
						.getData().VisibleOlusturButton = true;
					this.getView()
						.getModel("visibleModel")
						.getData().VisibleOlusturButton = true;
					this.getView()
						.getModel("visibleModel")
						.getData().VisibleTaslakButton = true;
					this.getView()
						.getModel("visibleModel")
						.getData().VisibleDegistirButton = true;
			...
			onChangeBelgeTipi: function (e) {
				...
				function a(e) {
					if (e == "OK") {
						...
						i.oDataView.headerData.comboBelgeTipi =
							i.oDataView.headerData.belgeTipi;
						i.bindView();
				...
				s.confirm(
					"Girilen veriler kaybolacak. Devam etmek istediğinizden emin misiniz?",
					a,
					"Uyarı"
				);
			},
			belgeTipKontrolEt: function (e) {
				...
				if (o === false) {
					...
					r.refresh(true);
					s.error(
						"Belge tipi bulunamadı.Lütfen doğru belge tipi girdidiğinizden emin olunuz"
					);
				}
			},
			bindView: function () {
			...
			getUserInfo: function () {
				...
				e.read(a, {
					...
					error: function (e) {
						o.hide();
						s.error(
							"Kullanıcı bilgilerinin alınması sırasında bir sorun oluştu. Lütfen sistem yöneticiniz ile iletişime geçiniz."
						);
					},
				});
			},
			...
			handlePressOlustur: function (e) {
				...
				var r = async() => {
					...
					s.confirm(
						"Belgeyi onaya göndermek istediğinize emin misiniz?",
						l,
						"Uyarı"
					);
				};
			...
			handlePressRejectDocument: function () {
				...
				s.confirm(
					"Belge onayını iptal etmek istediğinize emin misiniz?",
					t,
					"Uyarı"
				);
			},
				...
				function M(a, d) {
					...
					if (!g) {
						if (t === "AUTO" && (i && i != "")) {
							...
							s.success(
								a.EvScnum +
								" numaralı belgeniz başarılı bir şekilde oluşturulmuştur.", {
									onClose: function (e) {
										n
											.getOwnerComponent()
											.getRouter()
			...
			getDocumentDetail: function (e) {
				...
				i.read("/DocDetailSet", {
					...
					error: function (e) {
						o.hide();
						s.error(
							"Bir sorun oluştu. Lütfen sistem yöneticiniz ile iletişime geçiniz"
						);
					},
				});
			},
			_checkForm: function (e) {
				return new Promise(t => {
					...
					var d = false;
					if (
						(r.baslikEkAlanlari.ZzSecalm === "" ||
							r.baslikEkAlanlari.ZzSecalm === undefined) &&
						r.RequiredZZ_SECALM === true
					) {
						n = true;
						o = o + 1;
					...
					if (
						(r.baslikEkAlanlari.ZzSecndn === "" ||
							r.baslikEkAlanlari.ZzSecndn === undefined) &&
						r.RequiredZZ_SECNDN === true
					) {
						n = true;
						o = o + 1;
					...
					if (
						(r.baslikEkAlanlari.ZzAltur === "" ||
							r.baslikEkAlanlari.ZzAltur === undefined) &&
						r.RequiredZZ_ALTUR === true
					) {
						n = true;
						o = o + 1;
					...
					if (
						(r.baslikEkAlanlari.ZzBwart === "" ||
							r.baslikEkAlanlari.ZzBwart === undefined) &&
						r.RequiredZZ_BWART === true
					) {
						n = true;
						o = o + 1;
					...
					if (
						(r.baslikEkAlanlari.FieldWerks === "" ||
							r.baslikEkAlanlari.FieldWerks === undefined) &&
						r.RequiredFIELD_WERKS === true &&
						r.baslikEkAlanlari.Zzbwart == "301"
					) {
						n = true;
						o = o + 1;
					...
					if (
						(r.baslikEkAlanlari.FieldLgort === "" ||
							r.baslikEkAlanlari.FieldLgort === undefined) &&
						r.RequiredFIELD_LGORT === true
					) {
						n = true;
						o = o + 1;
					...
					if (
						(r.baslikEkAlanlari.ZzTlpedn === "" ||
							r.baslikEkAlanlari.ZzTlpedn === undefined) &&
						r.RequiredZZ_TLPEDN === true
					) {
						n = true;
						o = o + 1;
					...
					if (
						(r.baslikEkAlanlari.ZzTlpmdr === "" ||
							r.baslikEkAlanlari.ZzTlpmdr === undefined) &&
						r.RequiredZZ_TLPMDR === true
					) {
						n = true;
						o = o + 1;
					...
					if (
						(r.baslikEkAlanlari.ZzKulyer === "" ||
							r.baslikEkAlanlari.ZzKulyer === undefined) &&
						r.RequiredZZ_KULYER === true
					) {
						n = true;
						o = o + 1;
					...
					if (
						(r.baslikEkAlanlari.ZzMuthno === "" ||
							r.baslikEkAlanlari.ZzMuthno === undefined) &&
						r.RequiredZZ_MUTHNO === true
					) {
						n = true;
						o = o + 1;
					...
					if (
						(r.baslikEkAlanlari.ZzIncotrm === "" ||
							r.baslikEkAlanlari.ZzIncotrm === undefined) &&
						r.RequiredZZ_INCOTRM === true
					) {
						n = true;
						o = o + 1;
					...
					if (
						(r.baslikEkAlanlari.ZzIncopla === "" ||
							r.baslikEkAlanlari.ZzIncopla === undefined) &&
						r.RequiredZZ_INCOPLA === true
					) {
						n = true;
						o = o + 1;
					...
					if (
						(r.baslikEkAlanlari.ZzLifnr === "" ||
							r.baslikEkAlanlari.ZzLifnr === undefined) &&
						r.RequiredZZ_LIFNR === true
					) {
						n = true;
						o = o + 1;
					...
					if (
						(r.baslikEkAlanlari.ZzCevreb === "" ||
							r.baslikEkAlanlari.ZzCevreb === undefined) &&
						r.RequiredZZ_CEVREB === true
					) {
						n = true;
						o = o + 1;
					...
					for (var g = 0; g < r.malzemeBilgileri.length; g++) {
						...
						var m = false;
						if (
							(u.Prodi === "" || u.Prodi === undefined) &&
							r.RequiredPRODI === true &&
							!u.Hizmet
						) {
							...
							this.hataListesi.push({
								Message: "Lütfen " +
									h +
									" nolu kalemde malzeme numarası girişi yapınız.",
						...
						if (
							(u.Prodtx === "" || u.Prodtx === undefined) &&
							r.RequiredPRODTX === true
						) {
							...
							this.hataListesi.push({
								Message: "Lütfen " +
									h +
									" nolu kalemde malzeme tanımı girişi yapınız.",
						...
						if (
							(u.Matkl === "" || u.Matkl === undefined) &&
							r.RequiredMATKL === true
						) {
						...
						if (
							(u.Werks === "" || u.Werks === undefined) &&
							r.RequiredWERKS === true
						) {
							u.ValueStateUretimYeri = "Error";
							m = true;
							l = false;
						...
						if (
							(u.Lgort === "" || u.Lgort === undefined) &&
							r.RequiredLGORT === true
						) {
						...
						if (
							(u.Meins === "" || u.Meins === undefined) &&
							r.RequiredMEINS === true
						) {
						...
						if (
							(u.Taxbr === "" || u.Taxbr === undefined) &&
							r.RequiredTAXBR === true
						) {
						...
						if (
							(u.Taxtu === "" || u.Taxtu === 0 || u.Taxtu === undefined) &&
							r.RequiredTAXTU === true
						) {
						...
						if (
							(u.Eeind === "" || u.Eeind === undefined || u.Eeind === null) &&
							r.RequiredEEIND === true
						) {
							...
							this.hataListesi.push({
								Message: "Lütfen " +
									h +
									" nolu kalemde teslimat tarihi girişi yapınız.",
						...
						if (
							(u.Ekgrp === "" || u.Ekgrp === undefined) &&
							r.RequiredEKGRP === true
						) {
							...
							this.hataListesi.push({
								Message: "Lütfen " +
									h +
									" nolu kalemde satınalma grubu girişi yapınız.",
						...
						if (
							(u.Ekorg === "" || u.Ekorg === undefined) &&
							r.RequiredEKORG === true
						) {
							...
							this.hataListesi.push({
								Message: "Lütfen " +
									h +
									" nolu kalemde satınalma organizasyonu girişi yapınız.",
						...
						if (
							(u.Rsnum === "" || u.Rsnum === undefined) &&
							r.RequiredRSNUM === true
						) {
							...
							this.hataListesi.push({
								Message: "Lütfen " +
									h +
									" nolu kalemde Rezarvasyon no girişi yapınız.",
					...
					for (var g = 0; g < r.hesapTayiniBilgileri.length; g++) {
						...
						if (p.Hstyp === "" || p.Hstyp === undefined) {
							...
							this.hataListesi.push({
								Message: "Lütfen " +
									h +
									" nolu hesap tayininde hesap tayin tipi girişi yapınız.",
						...
						if (
							(p.Pypno === "" || p.Pypno === undefined) &&
							r.RequiredPYPNO === true &&
							(p.Hstyp != "2" && r.BelgeNumarasi != "DT_16_30_2")
						) {
							...
							this.hataListesi.push({
								Message: "Lütfen " +
									h +
									" nolu hesap tayininde pyp no girişi yapınız.",
						...
						if (
							(p.Kostl === "" || p.Kostl === undefined) &&
							r.RequiredKOSTL === true
						) {
							...
							this.hataListesi.push({
								Message: "Lütfen " +
									h +
									" nolu hesap tayininde masraf yeri girişi yapınız.",
						...
						if (
							(p.Aufnr === "" || p.Aufnr === undefined) &&
							r.RequiredAUFNR === true
						) {
							...
							this.hataListesi.push({
								Message: "Lütfen " +
									h +
									" nolu hesap tayininde Sipariş no girişi yapınız.",
						...
						if (
							(p.Kokrs === "" || p.Kokrs === undefined) &&
							r.RequiredKNTTP === true
						) {
							...
							this.hataListesi.push({
								Message: "Lütfen " +
									h +
									" nolu hesap tayininde kontrol kodu girişi yapınız.",
						...
						if (
							(p.Saknr === "" || p.Saknr === undefined) &&
							r.RequiredSAKNR === true
						) {
							...
							this.hataListesi.push({
								Message: "Lütfen " +
									h +
									" nolu hesap tayininde anahesap girişi yapınız.",
						...
						if (
							(p.Gsber === "" || p.Gsber === undefined) &&
							r.RequiredGSBER === true
						) {
							...
							this.hataListesi.push({
								Message: "Lütfen " +
									h +
									" nolu hesap tayininde iç alanı girişi yapınız.",
			...
			handlePressKalemEkle: function (e) {
				...
				var i = this.getView().getModel("detailModel").getData()
					.hesapTayiniBilgileri;
				var a = this.getView().getModel("detailModel").getData().headerData
					.belgeTipi;
				var r = this.getView().getModel("subMenuModel").getData();
				var s = this.getView().getModel("detailModel").getData().baslikBilgileri
					.Scnum;
				var l = null;
			...
			handlePressKalemSil: function (e) {
				...
				s.confirm(
					"Seçilen kalemleri silmek istediğinizden emin misiniz?",
					o,
					"Uyarı"
				);
			},
			...
			handlePressKalemKopyala: function (e) {
				...
				var r = this.getView().getModel("detailModel").getData()
					.malzemeBilgileri;
				var l = this.getView().getModel("detailModel").getData()
					.hesapTayiniBilgileri;
				var n = this.getView().getModel("detailModel").getData()
					.hesapTayiniBilgileri;
			...
			handlePressKalemDetay: function (e) {
				...
				if (!this.oMalzemeDetay) {
					this.oMalzemeDetay = sap.ui.xmlfragment(
						this.getView().getId(),
						"com.tupras.zsrmscp.view.Dialogs.MalzemeDetay",
						this
					);
			...
			handlePressNot: function (e) {
				...
				var s = this.getView().getModel("detailModel").getData()
					.malzemeBilgileri;
			...
			_openNotDialog: function (e) {
				...
				this.oNotDialog = new sap.m.Dialog({
					...
					content: new sap.m.TextArea("idTextAciklama", {
						...
						width: "94%",
						height: "400px",
						editable: this.getView().getModel("detailModel").getData()
							.headerData.editable,
					}).addStyleClass("sapUiSmallMargin"),
					beginButton: new sap.m.Button({
						type: sap.m.ButtonType.Emphasized,
						text: "Güncelle",
						enabled: this.getView().getModel("detailModel").getData().headerData
							.editable,
						press: function () {
							t.Descr = d.byId("idTextAciklama").getValue();
							this.getView().getModel("detailModel").refresh(true);
							this._changeNotSayisi(
			...
			notBackHesapTayini: function (e) {
				...
				if (s !== undefined) {
					...
					g.setText(
						a.removeLeadingZeroes(s.Itmno) + " nolu kalem hesap tayini"
					);
					var u = [];
			...
			notBack: function (e) {
				...
				var s = r.Itmno;
				var o = this.getView().getModel("detailModel").getData()
					.malzemeBilgileri;
				this.getView().byId("idButtonNext").setEnabled(true);
				var r = null;
			...
			handleValueHelpMasrafYeri: function (e) {
				this.selectedMasrafYeri = e
					.getSource()
					.getBindingContext("detailModel")
					.getObject();
				if (!this.oMasrafYeri) {
					this.oMasrafYeri = sap.ui.xmlfragment(
						this.getView().getId(),
						"com.tupras.zsrmscp.view.Dialogs.MasrafYeriSearchHelp",
						this
					);
			...
			onSubmitHareket: function () {
				...
				var t = this.getView()
					.getElementBinding()
					.getModel()
					.getPendingChanges("SmartfieldSet")["SmartfieldSet('')"]["Zzbwart"];
			...
			onSubmitFieldWerks: function () {
				...
				var t = this.getView()
					.getElementBinding()
					.getModel()
					.getPendingChanges("SmartfieldSet")["SmartfieldSet('')"][
						"FieldWerks"
					];
			...
			handleValueHelpPypNo: function (e) {
				...
				if (!this.oPypNo) {
					this.oPypNo = sap.ui.xmlfragment(
						this.getView().getId(),
						"com.tupras.zsrmscp.view.Dialogs.PypNoSearchHelp",
						this
					);
				...
				i.read(l, {
					success: function (i) {
						...
						this.internalUpdateItem(
							e.getSource().getBindingContext("detailModel").sPath,
							"WERKS"
						);
					},
					error: function (e) {
			...
			handleValueHelpMalgrubu: function (e) {
				...
				i.setSizeLimit(5e3);
				i.refresh();
				this.selectedMalgrubu = e
					.getSource()
					.getBindingContext("detailModel")
					.getObject();
				if (!this.oMalgrubu) {
					this.oMalgrubu = sap.ui.xmlfragment(
						this.getView().getId(),
						"com.tupras.zsrmscp.view.Dialogs.MalGrubuSearchHelp",
						this
					);
			...
			handleValueHelpTalepEden: function (e) {
				if (!this.oTalepEden) {
					this.oTalepEden = sap.ui.xmlfragment(
						this.getView().getId(),
						"com.tupras.zsrmscp.view.Dialogs.TalepEdenSearchHelp",
						this
					);
			...
			handleValueHelpMudurluk: function (e) {
				if (!this.oTalepMudurluk) {
					this.oTalepMudurluk = sap.ui.xmlfragment(
						this.getView().getId(),
						"com.tupras.zsrmscp.view.Dialogs.TalepEdenMudurlukSearchHelp",
						this
					);
			...
			handleValueHelpMuteahhit: function (e) {
				if (!this.oTalepMuteahhit) {
					this.oTalepMuteahhit = sap.ui.xmlfragment(
						this.getView().getId(),
						"com.tupras.zsrmscp.view.Dialogs.MuteahhitSearchHelp",
						this
					);
			...
			handleValueHelpUretimyeri: function (e) {
				this.selectedUretimyeri = e
					.getSource()
					.getBindingContext("detailModel")
					.getObject();
				this.selectedUretimYeriPath = e
					.getSource()
					.getBindingContext("detailModel")
					.getPath();
				if (!this.oUretimyeri) {
					this.oUretimyeri = sap.ui.xmlfragment(
						this.getView().getId(),
						"com.tupras.zsrmscp.view.Dialogs.UretimYeriSearchHelp",
						this
					);
			...
			handleValueHelpDepoyeri: function (e) {
				this.selectedDepoyeri = e
					.getSource()
					.getBindingContext("detailModel")
					.getObject();
				if (!this.oDepoyeri) {
					this.oDepoyeri = sap.ui.xmlfragment(
						this.getView().getId(),
						"com.tupras.zsrmscp.view.Dialogs.DepoYeriSearchHelp",
						this
					);
			...
			handleValueHelpParaBirimi: function (e) {
				this.selectedParabirimi = e
					.getSource()
					.getBindingContext("detailModel")
					.getObject();
				if (!this.oParaBirimi) {
					this.oParaBirimi = sap.ui.xmlfragment(
						this.getView().getId(),
						"com.tupras.zsrmscp.view.Dialogs.ParaBirimiSearchHelp",
						this
					);
			...
			handleValueHelpOlcuBirimi: function (e) {
				this.selectedOlcubirimi = e
					.getSource()
					.getBindingContext("detailModel")
					.getObject();
				if (!this.oOlcuBirimi) {
					this.oOlcuBirimi = sap.ui.xmlfragment(
						this.getView().getId(),
						"com.tupras.zsrmscp.view.Dialogs.OlcuBirimiSearchHelp",
						this
					);
			...
			handleValueHelpAnaHesap: function (e) {
				this.selectedAnaHesap = e
					.getSource()
					.getBindingContext("detailModel")
					.getObject();
				if (!this.oAnaHesap) {
					this.oAnaHesap = sap.ui.xmlfragment(
						this.getView().getId(),
						"com.tupras.zsrmscp.view.Dialogs.AnaHesapSearchHelp",
						this
					);
			...
			openAttachmentDialog: function () {
				if (!this._attachmentDialog) {
					this._attachmentDialog = sap.ui.xmlfragment(
						"com.tupras.zsrmscp.view.Dialogs.Attachment",
						this
					);
			...
			openExcelDialog: function () {
				if (!this._excelDialog) {
					this._excelDialog = sap.ui.xmlfragment(
						"com.tupras.zsrmscp.view.Dialogs.ExcelUpload",
						this
					);
			...
			handleUploadPress: function (e) {
				...
				var i = this._attachmentDialog.getModel("attachmentModel").getData()
					.Aciklama;
				var a = this._attachmentDialog.getModel("attachmentModel").getData()
					.Ektyp;
				...
				if (t.getValue() == "") {
					...
					t.setUploadUrl(
						"/sap/opu/odata/sap/ZMM_SCP_SRV/FileUploadHeaderSet('" +
						g +
						"|" +
						i +
						"|" +
			...
			handleUploadComplete: function (e) {
				...
				if (l !== 201) {
					...
					if (
						g.getElementsByTagName("d:ErrorText")[0].childNodes[0] !== undefined
					) {
						var u = g.getElementsByTagName("d:ErrorText")[0].childNodes[0]
							.nodeValue;
					} else {
						var u = "";
					}
			...
			getTempid: function () {
				...
				i.read(r, {
					...
					error: function (e) {
						o.hide();
						s.error(
							"Tempid alınması sırasında bir sorun oluştu.Lütfen sistem yöneticiniz ile iletişime geçiniz."
						);
					},
				});
			},
			...
			openOnayNotuDialogOnay: function (e) {
				if (!this.oOnayNotuFragment) {
					this.oOnayNotuFragment = sap.ui.xmlfragment(
						this.getView().getId(),
						"com.tupras.zsrmscp.view.Dialogs.OnayNotu",
						this
					);
			...
			kalemToplamHesapla: function (e, t, i) {
				...
				if (r == 0) {
					s.information(
						"Miktar Alanı 0 Girildiğinde Tutar Hesaplaması Yapılamamaktadır."
					);
					var t =
						e.getSource().getBindingContext("detailModel").sPath + "/Menge";
					var l =
						e.getSource().getBindingContext("detailModel").sPath + "/Ittot";
					var n = 1;
			...
			getHeaderToService: function (e) {
				...
				r.setProperty(
					"/SmartfieldSet('')/FieldWerks",
					i.baslikEkAlanlari.FieldWerks
				);
				r.setProperty(
					"/SmartfieldSet('')/FieldLgort",
					i.baslikEkAlanlari.FieldLgort
				);
				return a;
			},
			getItemToService: function () {
				...
				for (var r = 0; r < i.malzemeBilgileri.length; r++) {
					var s =
						i.malzemeBilgileri[r].Menge *
						i.malzemeBilgileri[r].Price /
						i.malzemeBilgileri[r].PriceUnit;
					a.push({
			...
			materialDialogOpen: function (e) {
				if (!this._oMaterialDialog) {
					this._oMaterialDialog = sap.ui.xmlfragment(
						"com.tupras.zsrmscp.view.Dialogs.MaterialShDialog",
						this
					);
			...
			handlePressMaterialDialogAdd: function (e) {
				...
				var n = this.getView()
					.getElementBinding()
					.getModel()
					.getPendingChanges("SmartfieldSet")["SmartfieldSet('')"]["Prodit"];
				var o = this.getView()
					.getElementBinding()
					.getModel()
					.getPendingChanges("SmartfieldSet")["SmartfieldSet('')"]["Prodi"];
				var d = this.getView()
					.getElementBinding()
					.getModel()
					.getPendingChanges("SmartfieldSet")["SmartfieldSet('')"]["Prodtx"];
				var g = this.getView()
					.getElementBinding()
					.getModel()
					.getPendingChanges("SmartfieldSet")["SmartfieldSet('')"]["Matkl"];
				var u = this.getView()
					.getElementBinding()
					.getModel()
					.getPendingChanges("SmartfieldSet")["SmartfieldSet('')"]["Matkltx"];
				if (n != "" && (o == "" || !o)) {
					o = n;
				}
				t.setProperty(s, g);
			...
			approverDialogOpen: function (e) {
				if (!this._oApproverDialog) {
					this._oApproverDialog = sap.ui.xmlfragment(
						"com.tupras.zsrmscp.view.Dialogs.ApproverShDialog",
						this
					);
			...
			handlePressApproverDialogAdd: function (e) {
				...
				var s = this.getView()
					.getElementBinding()
					.getModel()
					.getPendingChanges("SmartfieldSet")["SmartfieldSet('')"]["NameText"];
				var l = this.getView()
					.getElementBinding()
					.getModel()
					.getPendingChanges("SmartfieldSet")["SmartfieldSet('')"]["Uname"];
				t.setProperty(a, l);
				t.setProperty(r, s);
				t.refresh();
			...
			aufnrDialogOpen: function (e) {
				if (!this._oAufnrDialog) {
					this._oAufnrDialog = sap.ui.xmlfragment(
						"com.tupras.zsrmscp.view.Dialogs.AufnrShDialog",
						this
					);
			...
			handlePressAufnrDialogAdd: function (e) {
				...
				var r = this.getView()
					.getElementBinding()
					.getModel()
					.getPendingChanges("SmartfieldSet")["SmartfieldSet('')"]["Aufnr"];
				t.setProperty(a, r);
				t.refresh();
			...
			saknrDiyalogOpen: function (e) {
				if (!this._oSaknrDialog) {
					this._oSaknrDialog = sap.ui.xmlfragment(
						"com.tupras.zsrmscp.view.Dialogs.SaknrShDialog",
						this
					);
			...
			handlePressSaknrDialogAdd: function (e) {
				...
				var s = this.getView()
					.getElementBinding()
					.getModel()
					.getPendingChanges("SmartfieldSet")["SmartfieldSet('')"]["Saknr"];
				t.setProperty(a, s);
				t.refresh();
			...
			iwaerDiyalogOpen: function (e) {
				if (!this._oIwaerDialog) {
					this._oIwaerDialog = sap.ui.xmlfragment(
						"com.tupras.zsrmscp.view.Dialogs.IwaerShDialog",
						this
					);
			...
			handlePressIwaerDialogAdd: function (e) {
				...
				var o = this.getView()
					.getElementBinding()
					.getModel()
					.getPendingChanges("SmartfieldSet")["SmartfieldSet('')"]["Iwaer"];
				var d = this.getView()
					.getElementBinding()
					.getModel()
					.getPendingChanges("SmartfieldSet")["SmartfieldSet('')"]["Iwaertx"];
				t.setProperty(a, o);
				t.setProperty(r, d);
				if (!d && o) {
			...
			meinsDiyalogOpen: function (e) {
				if (!this._oMeinsDialog) {
					this._oMeinsDialog = sap.ui.xmlfragment(
						"com.tupras.zsrmscp.view.Dialogs.MeinsShDialog",
						this
					);
			...
			handlePressMeinsDialogAdd: function (e) {
				...
				var l = this.getView()
					.getElementBinding()
					.getModel()
					.getPendingChanges("SmartfieldSet")["SmartfieldSet('')"]["Meins"];
				var n = this.getView()
					.getElementBinding()
					.getModel()
					.getPendingChanges("SmartfieldSet")["SmartfieldSet('')"]["Msehl"];
				t.setProperty(a, l);
				t.setProperty(s, n);
				t.refresh();
			...
			lgortDiyalogOpen: function (e) {
				if (!this._oLgortDialog) {
					this._oLgortDialog = sap.ui.xmlfragment(
						"com.tupras.zsrmscp.view.Dialogs.LgortShDialog",
						this
					);
			...
			handlePressLgortDialogAdd: function (e) {
				...
				var s = this.getView()
					.getElementBinding()
					.getModel()
					.getPendingChanges("SmartfieldSet")["SmartfieldSet('')"]["Lgort"];
				t.setProperty(a, s);
				t.refresh();
			...
			werksDiyalogOpen: function (e) {
				if (!this._oWerksDialog) {
					this._oWerksDialog = sap.ui.xmlfragment(
						"com.tupras.zsrmscp.view.Dialogs.WerksShDialog",
						this
					);
			...
			handlePressWerksDialogAdd: function (e) {
				...
				var l = this.getView()
					.getElementBinding()
					.getModel()
					.getPendingChanges("SmartfieldSet")["SmartfieldSet('')"]["Werks"];
				var n = this.getView()
					.getElementBinding()
					.getModel()
					.getPendingChanges("SmartfieldSet")["SmartfieldSet('')"]["WerksDesc"];
				t.setProperty(a, l);
				t.setProperty(s, n);
				t.refresh();
			...
			matklDiyalogOpen: function (e) {
				if (!this._oMatklDialog) {
					this._oMatklDialog = sap.ui.xmlfragment(
						"com.tupras.zsrmscp.view.Dialogs.MatklShDialog",
						this
					);
			...
			pypDialogOpen: function (e) {
				if (!this._oPypDialog) {
					this._oPypDialog = sap.ui.xmlfragment(
						"com.tupras.zsrmscp.view.Dialogs.PypShDialog",
						this
					);
			...
			handlePressPypDialogAdd: function (e) {
				...
				var o = this.getView()
					.getElementBinding()
					.getModel()
					.getPendingChanges("SmartfieldSet")["SmartfieldSet('')"]["Pyp"];
				var d = this.getView()
					.getElementBinding()
					.getModel()
					.getPendingChanges("SmartfieldSet")["SmartfieldSet('')"]["ZpsTbeln"];
				t.setProperty(a, o);
				if (d && d != "") {
					n["ZzTesdrm"] = "TEVAR";
				} else {
			...
			kostlDialogOpen: function (e) {
				if (!this._oKostlDialog) {
					this._oKostlDialog = sap.ui.xmlfragment(
						"com.tupras.zsrmscp.view.Dialogs.KostlShDialog",
						this
					);
			...
			handlePressKostlDialogAdd: function (e) {
				...
				var n = this.getView()
					.getElementBinding()
					.getModel()
					.getPendingChanges("SmartfieldSet")["SmartfieldSet('')"]["Gsber"];
				var o = this.getView()
					.getElementBinding()
					.getModel()
					.getPendingChanges("SmartfieldSet")["SmartfieldSet('')"]["Kostl"];
				t.setProperty(a, o);
				t.setProperty(r, n);
				t.refresh();
			...
			openOnayNotuDialog: function (e) {
				if (!this._oRejectFragment) {
					this._oRejectFragment = sap.ui.xmlfragment(
						"com.tupras.zsrmscp.view.Dialogs.IptalNotu",
						this
					);
			...
			_getMessagePopover: function (e) {
				if (!e._oMessagePopover) {
					e._oMessagePopover = sap.ui.xmlfragment(
						"com.tupras.zsrmscp.view.Dialogs.messagePopover",
						this
					);
			...
			docCanChange: function (e) {
				...
				var i = t.getData();
				if (
					i["baslikBilgileri"]["Dstat"] &&
					i["baslikBilgileri"]["Dstat"] == "OGN"
				) {
					return false;
				} else {
					return true;
			...
			setSmartFieldValues: function (e) {
				...
				e.getView().getElementBinding().getModel()["mChangedEntities"][
					"SmartfieldSet('')"
				] = {};
				if (a.ZzBwart != "") {
			...
			downloadExcel: function () {
				return new Promise(e => {
					...
					function m(e, t) {
						...
						var s =
							i + "/ExcelDownloadSet(" + "IvGuid='" + e.IvType + "')/$value";
			...
			handlePressHizmetten: function () {
				...
				var r = this.getView().getModel("detailModel").getData()
					.hesapTayiniBilgileri;
				var s = this.getView().getModel("detailModel").getData().headerData
					.belgeTipi;
				var l = this.getView().getModel("subMenuModel").getData();
				var n = this.getView().getModel("detailModel").getData().baslikBilgileri
					.Scnum;
				var o = null;
			...
			teslimatChange: function (e) {
				...
				if (i - t - 864e5 > 0) {
					var a =
						e.getSource().getBindingContext("detailModel").getPath() + "/Eeind";
